...
class __TwigTemplate_df245674d2169fd3bc2c86d11b69c98ad8b9bc14a13c3014a0279eaec4185a0f extends Twig_Template
{
...
(isset($context["label_display"]) ? $context["label_display"] : null) == "visually_hidden")) ? ("visually-hidden") : ("")));
        ...
        foreach ($context['_seq'] as $context["delta"] => $context["item"]) {
            ...
            if (($this->getAttribute($this->getAttribute($context["item"], "caption", array()), "show", array()) == true)) {
                // line 68
                echo "<figure";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "field-type-image__figure", 1 => ("image-count-" . ($context["delta"] + 1)), 2 => "caption", 3 => "caption-img"), "method"), "html", null, true));
                echo " role=\"group\">";
            } else {
                // line 70
                echo "<figure";
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["item"], "attributes", array()), "addClass", array(0 => "field-type-image__figure", 1 => ("image-count-" . ($context["delta"] + 1))), "method"), "html", null, true));
                echo ">";
            }
            // line 72
        ...
        ";
            ...
            if (($this->getAttribute($this->getAttribute($context["item"], "caption", array()), "show", array()) == true)) {
                ...
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, (isset($context["caption_width"]) ? $context["caption_width"] : null), "html", null, true));
                echo ">";
